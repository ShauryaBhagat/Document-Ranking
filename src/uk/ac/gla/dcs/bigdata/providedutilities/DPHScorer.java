...
public class DPHScorer {
	 ...
	 * @param currentDocumentLength // the length of the current document (number of terms in the document)-----DONE
	 * @param averageDocumentLengthInCorpus // the average length across all documents -------------------------DONE
	 * @param totalDocsInCorpus // the number of documents in the corpus ---------------------------------------DONE
	 * @return
	 */
